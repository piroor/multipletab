 ...
 * **Is the "problem" really introduced by this addon?**
   If you use this addon with others, please confirm which addon actually causes the problem you met.
 ...
 * **Did you find other addon which provide the feature you are going to request?**
   If there is any other addon for the purpose, then this addon should become compatible to it instead of merging the feature into this addon itself.
...
If there is any [readme page](./README.md), please see it before you post a new feature request.
(Some my addon doesn't provide such an information, sorry.)
Even if a requested feature is very useful, it is possibly rejected by the project policy.

Instead, please tell me other addon which provide the feature and report a new issue as "compatibility issue with the addon, this addon should work together with it".
I'm very positive to make my addons compatible to others.
